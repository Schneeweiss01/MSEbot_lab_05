     ...
     switch(ui8Direction)
      {
        ...
        case 1:
        {
          ...
          ledcWrite(2,0);
          ledcWrite(1, 188);//ledcWrite(1,ui8LeftWorkingSpeed);//previously 151
          ledcWrite(4,0);
          ledcWrite(3, 180); //ledcWrite(3,ui8RightWorkingSpeed);//previously 130
        ...
        case 5:
        {//prevent beginning accel to right
          ledcWrite(2,0);
          ledcWrite(1, 164);//ledcWrite(1,ui8LeftWorkingSpeed);//previously 135
          ledcWrite(4,0);
          ledcWrite(3, 150); //ledcWrite(3,ui8RightWorkingSpeed);
          break;
        }
        case 6:
        {//prevent beginning reverse accel to right
          ledcWrite(1,0);
          ledcWrite(2, 135);//ledcWrite(1,ui8LeftWorkingSpeed);
          ledcWrite(3,0);
          ledcWrite(4, 130); //ledcWrite(3,ui8RightWorkingSpeed);//previoiusly 135
          break;
        }
