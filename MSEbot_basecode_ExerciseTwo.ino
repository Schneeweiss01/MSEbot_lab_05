...
//*************************************************************************************************    
      ...
      if (btRun)
      {
        if (state == 0)//Move forward
        {
           if( ENC_vi32RightOdometer <40)//start correction
            ...
            else if( ENC_vi32RightOdometer <230)                                                            //HAVE TO CODE THIS NUMBER
            {
            //set up a boolean of should be forward should be backwards
            //if the encoders should be forward
            ENC_SetDistance(100, 100);
          ...
          {
            CR1_ulMotorTimerNow=millis();
            if(CR1_ulMotorTimerNow - CR1_ulMotorTimerPrevious <= 350)//after X seconds go to next part     //HAVE TO CODE THIS NUMBER
          {
          ...
          {
            CR1_ulMotorTimerNow=millis();
            if(CR1_ulMotorTimerNow - CR1_ulMotorTimerPrevious <= 425)//after X seconds go to next part     //HAVE TO CODE THIS NUMBER
          {
         ...
         else if(state ==6)//Move Forward
          {
            ...
            else if( ENC_vi32RightOdometer <75)                                                            //HAVE TO CODE THIS NUMBER
            {
            //set up a boolean of should be forward should be backwards
            //if the encoders should be forward
            ENC_SetDistance(100, 100);
          ...
          {
            CR1_ulMotorTimerNow=millis();
            if(CR1_ulMotorTimerNow - CR1_ulMotorTimerPrevious <= 365)//after X seconds go to next part     //HAVE TO CODE THIS NUMBER
          {
            ENC_SetDistance(-(ci8LeftTurn), ci8LeftTurn);
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
          ...
          else if(state ==8)//Move Forward
          {
           if( ENC_vi32RightOdometer <40)//start correction
            ...
            else if( ENC_vi32RightOdometer <300)                                                            //HAVE TO CODE THIS NUMBER
            {
            //set up a boolean of should be forward should be backwards
            //if the encoders should be forward
            ENC_SetDistance(100, 100);
            ucMotorState = 7;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
            breakTimer=millis();
   ...
   //   asm volatile("esync; rsr %0,ccount":"=a" (vui32test2)); // @ 240mHz clock each tick is ~4nS 
    ...
    {
       if (CR1_ui8IRDatum == 0x55 && backwards==0) {                // if proper character is seen
         SmartLEDs.setPixelColor(0,0,25,0);         // make LED1 green with 10% intensity
       }
       else if (CR1_ui8IRDatum == 0x41 || backwards==1) {           // if "hit" character is seen
